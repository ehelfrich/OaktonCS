...
public class Sorts {
	...
	static public void resetSwapCount() {
		numSwaps = 0;
	}

	static public void resetCompCount() {
		numComps = 0;
	}
	...
	public static void shortBubble()
	// Sorts the values array using the bubble sort algorithm.
	...
	public static int newHole(int hole, int lastIndex, int item)
	...
	public static void reheapDown(int item, int root, int lastIndex)
