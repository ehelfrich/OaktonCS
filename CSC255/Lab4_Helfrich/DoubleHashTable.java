public class DoubleHashTable<AnyType> {
	/**
	 * Double Hash table implementation of hash tables. Note that all "matching"
	 * is based on the equals method.
	 * 
	 * Based off of:
	 * 
	 * @author Mark Allen Weiss Edited by Eric Helfrich
	 */
